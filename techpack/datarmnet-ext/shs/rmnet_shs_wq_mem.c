...
={.proc_mmap=DATARMNET54418f934d,.proc_open=DATARMNET33a80d3bf7,.
...
proc_mmap=DATARMNETc55748448d,.proc_open=DATARMNET0935e3beb9,.proc_release=DATARMNET2a9f67714f,
.proc_read=DATARMNETaf2aa1d70f,.proc_write=DATARMNET4761dcd3fd,};static const struct
proc_ops DATARMNET8fe5f892a8={.proc_mmap=
DATARMNET43c6d751a2,.proc_open=DATARMNETfbd34e70a2,.proc_release=DATARMNET968bc5b80d,.proc_read
=DATARMNETaf2aa1d70f,.proc_write=DATARMNET4761dcd3fd,};static const struct 
proc_ops DATARMNET0104d40d4b={.proc_mmap=
DATARMNET7cc042bdf3,.proc_open=DATARMNET57bcb932f3,.proc_release=DATARMNET59b415aded,.proc_read
=DATARMNETaf2aa1d70f,.proc_write=DATARMNET4761dcd3fd,};static const struct 
proc_ops DATARMNET6eb63d9ad0={.proc_mmap=
DATARMNET444e2eb654,.proc_open=DATARMNETb9d10d8cc0,.proc_release=DATARMNET18464ea5e3,.proc_read
=DATARMNETaf2aa1d70f,.proc_write=DATARMNET4761dcd3fd,};void DATARMNET28a80d526e(
